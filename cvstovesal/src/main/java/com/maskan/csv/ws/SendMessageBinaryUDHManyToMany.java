...
/**
 * <p>Java class for sendMessageBinaryUDHManyToMany complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="sendMessageBinaryUDHManyToMany">
 *   &lt;complexContent>
 ...
 *         &lt;element name="udh" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "sendMessageBinaryUDHManyToMany1", propOrder =  {
    "username",
    "password",
    "originator",
    "destination",
...
public class SendMessageBinaryUDHManyToMany {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the udh property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<String> getUdh() {
        if (udh == null) {
            udh = new ArrayList<String>();
        }
        return this.udh;
    }
